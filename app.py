...
width=10, bg="dark olive green", fg="white", font=("ariel", 16, "bold"))
    ...
    def display_title(self):
        ...
        title = Label(gui, text="QUIZ MANAGEMENT SYSTEM",
    ...
    def display_details(self):
        ...
        details = Label(gui, text=f'''Student name:{student1.name}
                                    Teacher's name:{teacher1.name}
                                    Parent's name:{parent1.name}''',
                      width=40, bg="black", fg="white", font=("ariel", 15, "bold"))

         
        details.place(x=70, y=100)
...
teacher1 = Teacher("Mr. Smith", 35)
parent1 = Parent("Mrs. Johnson", 40)
